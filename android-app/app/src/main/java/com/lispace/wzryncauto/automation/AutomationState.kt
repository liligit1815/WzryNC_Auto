...
object AutomationTransitionPolicy {
    private val allowed = mapOf(
        ...
        AutomationState.WAITING_LOGIN to setOf(AutomationState.CLICKING_START_GAME),
        AutomationState.CLOSING_AD_POPUPS to setOf(AutomationState.WAITING_LOBBY),
        AutomationState.CLOSING_STARTUP_POPUPS to setOf(AutomationState.CLICKING_START_GAME),
        AutomationState.CLICKING_START_GAME to setOf(AutomationState.CLOSING_AD_POPUPS),
        AutomationState.WAITING_LOBBY to setOf(AutomationState.ENTERING_FARM),
        ...
        AutomationState.MOVING_TO_STATUE to setOf(
            AutomationState.VERIFYING_ONE_CLICK_FARM,
            AutomationState.RECOVERING_FARM_ACTION,
        ),
        AutomationState.RECOVERING_FARM_ACTION to setOf(AutomationState.MOVING_TO_FARMLAND),
        ...
        AutomationState.VERIFYING_FARMLAND to setOf(
