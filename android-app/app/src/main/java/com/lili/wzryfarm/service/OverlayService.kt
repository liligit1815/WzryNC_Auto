package com.lili.wzryfarm.service
...
import com.lili.wzryfarm.MainActivity
import com.lili.wzryfarm.R
import com.lili.wzryfarm.automation.AutomationControl
import com.lili.wzryfarm.automation.AutomationState
import com.lili.wzryfarm.automation.EnterFarmAutomation
import com.lili.wzryfarm.automation.FarmActionAutomation
import com.lili.wzryfarm.automation.RootAutomationRuntime
...
import com.lili.wzryfarm.device.BrightnessSnapshot
...
import com.lili.wzryfarm.schedule.FarmSchedule
import com.lili.wzryfarm.schedule.FarmScheduleCalculator
import com.lili.wzryfarm.schedule.FarmStateStore
import com.lili.wzryfarm.schedule.WakeReason
...
class OverlayService : Service() {
    ...
    private val automationRuntime by lazy {
        RootAutomationRuntime(deviceController, screenshotCapture, templateMatcher, ocrEngine)
    }
    ...
    private fun showPanel() {
        ...
        content.addView(horizontalRow().apply {
            addView(label("王者农场助手", 18f), weighted())
    ...
    private fun logSchedule(schedule: FarmSchedule, freshBatch: Boolean) {
        ...
        appendLog("提前 2 分钟执行：${schedule.wakeAt.format(DATE_TIME_FORMAT)}")
    }
    ...
    private fun isKeyLog(message: String): Boolean {
        ...
        return keyPhrases.any(message::contains)
    }
    ...
    /**
     * Shows operation-boundary feedback even while the panel is collapsed.
     * Polling and retry logs must not call this method, otherwise Toasts would
     * obscure the game continuously.
     */
    ...
    companion object {
        ...
        const val ACTION_STOP_SERVICE = "com.lili.wzryfarm.STOP_OVERLAY"
        const val ACTION_EMERGENCY_STOP = "com.lili.wzryfarm.EMERGENCY_STOP"
        const val ACTION_TEST_SCREENSHOT = "com.lili.wzryfarm.TEST_SCREENSHOT"
        const val ACTION_TEST_OCR = "com.lili.wzryfarm.TEST_OCR"
        const val ACTION_START_AUTOMATION = "com.lili.wzryfarm.START_AUTOMATION"
